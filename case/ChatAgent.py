...
def interactive_search_tool(query: str) -> str:
    """搜索引擎工具的交互式包装函数"""
...
def rag_tool(query: str) -> str:
    """知识库查询工具"""
    try:
        search = vectorManager.get_retriever("Government_Work_Report_2025", 3, 0.5, use_ensemble=True)
...
def interactive_rag_tool(query: str) -> str:
    """知识库查询工具的交互式包装函数"""
